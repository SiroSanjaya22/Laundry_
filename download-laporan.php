...
<body>
<center><h1>Pondok Laundry</h1>
<h3>Laundry & Dry Cleaning</h3>
<h3>Hp : 0822 8284 5087</h3>
</center>
<hr>
<?php
...
<table class="table" >
  ...
  <tbody>
      <?php
        ...
        $i = 1;
        $sql = mysqli_query($conn, "SELECT Jenis_Pakaian, Jumlah_Pakaian, harga_pakaian,Total_harga from (detail_transaksi join pakaian on detail_transaksi.Id_Pakaian = pakaian.Id_Pakaian) WHERE No_Order = '$No_Order'");
        while ($hasil = mysqli_fetch_array($sql)) {
     ?>
      <tr>
...
<div class="">
  ...
  <p>Kategori (Rp): <?php echo $hasil['diskon']; ?></p>
</div>
<hr>
