  ...
  <body>
    ...
    <header class="jumbotron bg-inverse text-xs-center center-vertically" role="banner">
      <div class="container">
        ...
        <h2 class="m-b-3">Bersih, <em>Wangi</em>, dan Ekonomis <br><a href="ui-elements.html" class="jumbolink">Powered by Matadeveloper</a>.</h2>
        ...
        <ul class="nav nav-inline social-share">
          <li class="nav-item"><a class="nav-link" href="#"> username : matadeveloper</a></li>
          <li class="nav-item"><a class="nav-link" href="#"> password : matadeveloper</a></li>
        </ul>
      </div>
    </header>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-7">
            <ul class="nav nav-inline">
              <li class="nav-item">
                <a href="https://matadeveloper.com" class="nav-link" href="">Matadeveloper.com<span class="sr-only"></span></a>
              </li>
            </ul>
          </div>
        </div>
