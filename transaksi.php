  ...
  <tr>
      ...
      <a href="#" class="btn btn-primary">Konfirmasi</a>
        <?php
         ...
         ?>
      <a href="download-laporan.php?cetak=<?php echo $hasil['No_Order']; ?>" class="btn btn-info" id="PrintButton" onclick="PrintPage()<span class="glyphicon glyphicon-print">Cetak</a>
